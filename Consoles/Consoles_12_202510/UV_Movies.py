...
def quick_movie_wrap(folder_path):
    ...
    if '_111024' in folder_path.name or 'BigMatrix' in str(folder_path):
    ...
    elif '_161224' in folder_path.name or 'SmallMatrix' in str(folder_path):
        mapping = Path('../../Files/Mapping_BigMatrix_2.xlsx')
...
# '''
# ---------------------------------------------------------------------------------------------------------------------
folder_path = Path('/Users/nico_brosda/Cyrce_Messungen/matrix_071025_UVTest/BigMatrix/Pinhole')
crit = 'Pinhole_xscan'
output_path = Path(f'/Users/nico_brosda/Cyrce_Messungen/ResultsUV/MovieTime/{folder_path.parent.name}/{crit}/')
...
analyzer.norm_factor = np.ones_like(analyzer.norm_factor)
generate_movie(analyzer, folder_path, crit, output_path, frame_select=frame_select, zero_frame=zero_frame, cmap=cmap,
               ...
               return_info=return_info, sub_time=sub_time, intensity_limits=intensity_limits)
# '''

'''
# ---------------------------------------------------------------------------------------------------------------------
folder_path = Path('/Users/nico_brosda/Cyrce_Messungen/matrix_071025_UVTest/BigMatrix/scans')
crit = 'YMove2_1ms'
output_path = Path(f'/Users/nico_brosda/Cyrce_Messungen/ResultsUV/MovieTime/{folder_path.parent.name}/{crit}/')
analyzer = quick_movie_wrap(folder_path)
analyzer.scale = 'nano'
