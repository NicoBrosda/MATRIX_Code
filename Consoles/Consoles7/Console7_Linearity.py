...
signal_comparison_channel(folder_path2, results_path, ['exp6_25nA_nA_1.9_x_0_y_0', 'exp12_25nA_12_12_2024_16_04_42'],
                  'exp8_dark_without_cup_nA_1.9_x_0_y_0', B, names=['Before Irradiation', 'After irradiation'], normed=False, mark_n=[], save_plot=False, lw=1.5, color_list=colors[0:])
signal_comparison_channel(folder_path, results_path, ['exp3_nA_1.9_x_28.25_y_0.0'], 'exp2_nA_1.9_x_28.25_y_0.0', A, names=['Months later'], add_plot=True, normed=False, lw=1.5, color_list=colors[2:])