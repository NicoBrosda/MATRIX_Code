...
ax4.text(*transform_axis_to_data_coordinates(ax4, [0.5, 0.97]), '2x64 array \n 0.25$\\,$mm offset', fontsize=11, ha='center',
        va='top', color='k')
'''
just_save(save_path=results_path, save_name=f"Graph3_v1_LogoComp", dpi=dpi, plot_size=plot_size, save_format=format, fig=fig)

# ---------------------------------------------------------------------------------------------------------------------
# ---------------------------------------------------------------------------------------------------------------------

plot_size = (9 * cm, 27 / 1.2419 * cm)
# Setup of the final figure
...
ax4.text(*transform_axis_to_data_coordinates(ax4, [0.5, 0.97]), '2x64 array \n 0.25$\\,$mm offset', fontsize=11, ha='center',
        va='top', color='k')
'''
just_save(save_path=results_path, save_name=f"Graph3_v2_LogoComp", dpi=dpi, plot_size=plot_size, save_format=format, fig=fig)