...
format_save(save_path=results_path, save_name=f"NiceLogoLowRes", dpi=dpi, plot_size=fullsize_plot,
...
format_save(save_path=results_path, save_name=f"NiceLogoHighRes", dpi=dpi, plot_size=fullsize_plot,
            save_format=save_format, fig=fig, legend=False)
# ------------------------------------------------------------------------------------------------------------------
# Ax3: Logo Gafchromic
# ------------------------------------------------------------------------------------------------------------------
...
format_save(save_path=results_path, save_name=f"NiceLogoGaf", dpi=dpi, plot_size=fullsize_plot,
            save_format=save_format, fig=fig, legend=False)
# ------------------------------------------------------------------------------------------------------------------
# Ax4: Profile Logo
# ------------------------------------------------------------------------------------------------------------------
