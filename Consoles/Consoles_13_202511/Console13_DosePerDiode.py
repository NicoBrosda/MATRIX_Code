...
save_path = Path(f'/Users/nico_brosda/Cyrce_Messungen/ResultsPEEK_161225/SimulationCompActiveLayer/')
...
proton_density_distribution = counts / Np
...
dose1 = dose_norm * time_mark_8nA * (8e-9 / e)
# After that 25 nA into setup
dose2 = dose_norm * (times.max()-time_mark_8nA) * (25e-9 / e)
